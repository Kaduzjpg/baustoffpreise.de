...
export function Hero() {
  return (
    <section className="relative overflow-hidden rounded-3xl border bg-light">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-white/70 to-white/10" />
      </div>
      <div className="relative container py-16 md:py-24 grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            <span className="inline-flex items-center rounded-full border bg-white/70 px-3 py-1">Regional</span>
            <span className="inline-flex items-center rounded-full border bg-white/70 px-3 py-1">Transparent</span>
            <span className="inline-flex items-center rounded-full border bg-white/70 px-3 py-1">Persönlicher Service</span>
          </div>
          <div className="flex flex-wrap gap-3">
            <Link href="/kategorien" className="btn-primary">Produkte ansehen</Link>
