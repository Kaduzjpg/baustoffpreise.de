...
export function FloatingCartButton() {
  ...
  return (
    <Link href="/anfragekorb" className="fixed bottom-6 right-6 inline-flex items-center gap-2 rounded-full bg-brand text-white px-5 py-3 shadow-soft hover:scale-[1.03] transition-transform ease-smooth">
