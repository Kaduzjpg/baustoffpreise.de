...
export function FloatingCartButton() {
  ...
  return (
    <Link href="/anfrage/absenden" className="fixed bottom-6 right-6 inline-flex items-center gap-2 rounded-full bg-brand-green text-white px-5 py-3 shadow-soft hover:scale-[1.03] transition-transform ease-smooth">
